...
## Latest News
`2024.05.23` PaddleHelix released the codes of HelixDock, a pre-training model on large-scale generated docking conformations to unlock the potential of protein-ligand structure prediction, significantly improving prediction accuracy and generalizability. Please refer to [paper]([https://arxiv.org/abs/2207.13921](https://arxiv.org/abs/2310.13913)) and [codes](./apps/molecular_docking/helixdock) for more details. Welcome to [[PaddleHelix website](https://paddlehelix.baidu.com/app/drug/protein-single/forecast](https://paddlehelix.baidu.com/app/drug/helix-dock/forecast)) to try out the structure prediction online service.
