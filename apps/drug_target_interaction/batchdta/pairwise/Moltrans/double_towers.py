...
class MolTransModel(nn.Sequential):
    ...
    def forward_single(self, d, t, d_masking, t_masking):
        """
        Double Towers
        """
    ...
    def forward(self, d1,t1,d2,t2,d1_mask,t1_mask,d2_mask,t2_mask):
        res1 = self.forward_single(d1, t1, d1_mask, t1_mask)
        res2 = self.forward_single(d2, t2, d2_mask, t2_mask)
        res = res1-res2
        return res
