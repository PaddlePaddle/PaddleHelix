import pdb
from layers.basics import TriangleMultiplication
...
c = cfg['model']['embeddings_and_evoformer']['evoformer']['triangle_multiplication_incoming']
...
prefix_weights = 'dynamic_params/trianglemultiplication' if is_dynamic_input else 'static_params/trianglemultiplication'
...
model = TriangleMultiplication(channel_num, c, gc)
model.eval()
