import pdb
from layers.head import StructureModule
...
c = cfg['model']['heads']['structure_module']
...
print('# [INFO] build and save static graph of StructureModule')
model = StructureModule(channel_num, c, gc)
model.eval()
