...
# def get_identifiers(description: str, species_identifer_map: dict) -> Identifiers:
...
#     if word[0].isupper() and i+1 < len(word_list) and ' '.join(word_list[i:i+2]) in species_identifer_map:
#       identifer = species_identifer_map[' '.join(word_list[i:i+2])]
