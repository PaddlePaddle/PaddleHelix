...
from helixfold.data.tf_input import data_transforms
from helixfold.data.tf_input import shape_placeholders
...
def ensembled_map_fns(data_config):
  ...
  if eval_cfg.delete_msa_block:
    map_fns.append(data_transforms.block_delete_msa(eval_cfg))
