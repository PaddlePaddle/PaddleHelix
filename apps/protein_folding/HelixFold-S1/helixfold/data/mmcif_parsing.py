...
def _get_protein_chains(
  ...
  # Get entity polymer types
  entity_poly_types = mmcif_loop_to_dict('_entity_poly.', '_entity_poly.entity_id', parsed_info)
  ...
  for entity_id, seq_info in polymers.items():
    ...
    if entity_id in entity_poly_types and 'polypeptide(L)' in entity_poly_types[entity_id]['_entity_poly.type']:
