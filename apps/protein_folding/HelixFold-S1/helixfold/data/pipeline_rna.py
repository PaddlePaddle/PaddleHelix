...
"""Functions for building the input RNA features for the AlphaFold model."""
...
def make_sequence_features(
  ...
  # TODO: Add support for neucliotide sequences.
  features = {}
...
def make_msa_features(msas: Sequence[parsers.Msa], max_align_depth: Optional[int], species_identifer_df=None) -> FeatureDict:
...
class RNADataPipeline:
  ...
  def process(self, input_fasta_path: str, msa_output_dir: str) -> FeatureDict:
    ...
    msa_features = make_msa_features(msas, species_identifer_df=self.species_identifer_df, max_align_depth=self.total_max_hits)
