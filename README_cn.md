...
`2021.05.18` 论文"Structure-aware Interactive Graph Neural Networks for the Prediction of Protein-Ligand Binding Affinity"被KDD 2021接收。代码参见[这里](./apps/drug_target_interaction/sman).
