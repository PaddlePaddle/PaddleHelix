...
class Learner(object):
        ...
        train_run_hooks = [
            ...
            hooks.LoggingHook(
                ...
                summary_writer=_get_summary_writer(
                    os.path.join(self.run_config.model_dir, 'train_history%s' % self.run_config.log_id)),
    ...
    def evaluate(self, eval_dataset, eval_hooks=[]):
        ...
        summary_writer = _get_summary_writer(
            os.path.join(self.run_config.model_dir, 'eval_history%s' % self.run_config.log_id))
        ...
        def __init__(self):
            ...
            self.summary_writers = {
                ds_name: _get_summary_writer(
                    os.path.join(
                        os.path.join(run_config.model_dir, 'eval_history%s' % run_config.log_id),
                        ds_name))
